  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-white to-teal-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-red-600 to-amber-500 p-2 rounded-xl">
            ...
            <div className="hidden lg:block flex-1 px-8">
              <p className="text-center text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-700 to-amber-600 tracking-wide">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="hidden sm:flex items-center gap-2 text-gray-700 hover:text-red-600 font-medium transition-colors duration-300"
              >
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-red-600 to-amber-500 hover:from-rose-600 hover:to-teal-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Donate Now
              </Button>
            </div>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-red-50/50 to-amber-50/50"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  size="lg"
                  onClick={() => handleDonateClick()}
                  className="bg-gradient-to-r from-red-600 to-amber-500 hover:from-sky-600 hover:to-violet-600 text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
                ...
                <Button 
                  ...
                  className="border-2 border-red-600 text-red-700 hover:bg-red-50 font-semibold text-lg"
                >
                  See Your Impact
                </Button>
              </div>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-red-400/20 to-amber-400/20 blur-3xl"></div>
              <img 
                ...
                <>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-3xl font-bold text-red-600">{campaignData.percentComplete}%</p>
                      <p className="text-gray-600">{campaignData.donorCount} donors</p>
                    </div>
                  </div>
                  <Progress value={campaignData.percentComplete} className="h-4 bg-red-100" />
                </>
              )}
            </CardContent>
          </Card>
              ...
              return (
                <Card 
                  ...
                  className={`hover:shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer overflow-hidden ${
                    tier.featured ? 'border-4 border-red-600 relative' : 'border-2 border-gray-200'
                  }`}
                  onClick={() => handleDonateClick(tier)}
                >
                  {tier.featured && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                      <span className="bg-gradient-to-r from-red-600 to-amber-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                        Most Popular
                      </span>
                    </div>
                  )}
      ...
      {/* Donation Form */}
      {showDonationForm && (
        <section id="donation-form" className="py-20 bg-gradient-to-br from-red-50 to-amber-50">
          <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:customerservice@adesglobal-nonprofit.com" className="text-gray-400 hover:text-amber-400 transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://adesglobal-nonprofit.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-amber-400 transition-colors">
