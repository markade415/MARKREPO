...
const DonationForm = ({ selectedTier, onSuccess }) => {
      ...
      <Card className="max-w-2xl mx-auto border-4 border-green-500 shadow-2xl">
        <CardContent className="p-12 text-center space-y-6">
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-green-700 to-green-600 hover:from-sky-600 hover:to-violet-600 text-white font-bold"
          >
  ...
  return (
    <Card className="max-w-2xl mx-auto border-4 border-green-300 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 text-2xl font-bold border-2 border-green-300 focus:border-green-600 h-16"
          ...
          <div className="grid grid-cols-4 gap-3">
            {[25, 50, 100, 250].map((presetAmount) => (
              <Button
                ...
                className={amount == presetAmount ? "bg-green-600 hover:bg-green-700" : "border-green-300 hover:bg-green-50"}
              >
                ${presetAmount}
              </Button>
            ))}
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod}>
              <div className="flex items-center space-x-3 border-2 border-gray-200 rounded-lg p-4 hover:border-green-300 transition-colors">
          ...
          <Button 
            ...
            className="w-full bg-gradient-to-r from-green-700 to-green-600 hover:from-sky-600 hover:to-violet-600 text-white font-bold text-xl h-16 shadow-xl hover:shadow-2xl transition-all duration-300"
          >
            {isProcessing ? (
              <>
